...
# lines = Detect_Text('C:/Users/21100002/Desktop/all image/2.jpg')
# print(lines)
def all_text(lines):
    raw_text = ""
    for line in lines:
...
# wbc 
def specific_text_wbc(raw_text):
                ...
                if len(wbc_prob_val) > 0:
                    ...
                    if "K/UL" in wbc_prob_unit or "10^3/UL" in wbc_prob_unit or "/L" in wbc_prob_unit \
                        ...
                        if wbc_val < 300:
                            ...
                            wbc_si_val = wbc_val / 1000
                            # print("WBC SI VALUE =", wbc_si_val)
                return wbc_si_val

# rbc 
def specific_text_rbc(raw_text):
    raw_text = raw_text.replace("total", "", raw_text.count("total"))
    raw_text = raw_text.replace("count", "", raw_text.count("count"))
    raw_text = raw_text.replace(",", "", raw_text.count(","))
    raw_text = raw_text.replace("µ", "u", raw_text.count("µ"))
...
def specific_text_plt(raw_text):
    raw_text = raw_text.replace("total", "", raw_text.count("total"))
    raw_text = raw_text.replace("count", "", raw_text.count("count"))
    raw_text = raw_text.replace(",", "", raw_text.count(","))
    raw_text = raw_text.replace("µ", "u", raw_text.count("µ"))
    ...
    for i in text_list[:]:                
        ...
        # # PLT END
def specific_text_hbg(raw_text):
    raw_text = raw_text.replace("total", "", raw_text.count("total"))
    raw_text = raw_text.replace("count", "", raw_text.count("count"))
    raw_text = raw_text.replace(",", "", raw_text.count(","))
    raw_text = raw_text.replace("µ", "u", raw_text.count("µ"))
...
# raw_text = all_text(lines)
# print(raw_text)
# wbc_ = specific_text_wbc(raw_text)
# print('wbc ',wbc_)

# rbc_ = specific_text_rbc(raw_text)
# print('rbc ',rbc_)

# plt_ = specific_text_plt(raw_text)
# print('plt ',plt_)

# hbg_ = specific_text_hbg(raw_text)
# print('hbg ',hbg_)
